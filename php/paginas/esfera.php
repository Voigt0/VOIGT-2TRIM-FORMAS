...
<?php
    ...
    $circulo_id = isset($_POST['circulo_id']) ? $_POST['circulo_id'] : 0;
    ...
    <content>
        ...
        <div class="tab-content" id="nav-tabContent">
                ...
                <div class="">
                    <table id="example" class="table table-striped" style="background-color: #FFF;">
                        ...
                        <?php
                            ...
                            $tabela = Esfera::listar($busca, $pesquisa);
                            foreach($tabela as $key => $value) {
                        ?>
                            <tr>
                                <th scope="row"><?php echo $value['id'];?></th>
                                <td scope="row"><div style="height: 5vh; background-color: <?php echo $value['cor'];?>"> <?php echo $value['cor'];?> </div></td>
                                <td scope="row"><?php echo $value['circulo_id'];?></td>
                                <td scope="row"><?php echo $value['tabuleiro_id'];?></td>
                                <td scope="row"><?php echo $value['raio'];?></td>
                                <td scope="row"><a href="esfera.php?id=<?php echo $value['id'];?>"><img src="../../img/edit.svg" style="width: 3vw;"></a></td>
                                <td><a onclick="return confirm('Deseja mesmo excluir?')" href="../controle/controleGeral.php?id=<?php echo $value['id'];?>&operation=delete&table=esfera"><img src="../../img/delete.svg" style="width: 3vw;"></a></td>
                                <td><a href="../show/showEsfera.php?id=<?php echo $value['id']; ?>&circulo_id=<?php echo $value['circulo_id'];?>&cor=<?php echo str_replace('#', '%23', $value['cor']);?>&tabuleiro_id=<?php echo $value['tabuleiro_id']?>&raio=<?php echo $value['raio']?>"><img src='../../img/list.svg' style="width: 3vw;"></a></td>
                            </tr>
                        <?php
                            } 
                        ?> 
            ...
            <div class="tab-pane fade  <?php if(isset($id)){echo 'show active';} ?>" id="nav-form" role="tabpanel" aria-labelledby="nav-form-tab" tabindex="0">
                <form action="<?php if(isset($_GET['id'])) { echo "../controle/controleGeral.php?id=$id&operation=update&table=esfera";} else {echo "../controle/controleGeral.php?operation=create&table=esfera";} ?>" method="post" id="form" style="padding-left: 5vw; padding-right: 5vw;">
                    <br>
                    ...
                    <select name="circulo_id"  id="circulo_id" class="form-select">
                        <?php
                            ...
                            echo selectBox('circulo', array('circulo_id', 'circulo_id'), $data[0]['circulo_id']);
                        ?>
                    </select>
                    <br>

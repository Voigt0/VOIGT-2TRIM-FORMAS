...
<?php
    ...
    if(isset($_GET['id'])) {
        $id = $_GET['id'];
        $data = Quadrado::consultarData($id);
    }
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade <?php if(!isset($id)){echo 'show active';} ?>" id="nav-table" role="tabpanel" aria-labelledby="nav-table-tab" tabindex="0">
                ...
                <form action="" method="post" style="padding-left: 5vw; padding-right: 5vw;">
                    ...
                    <br>
                    <input type="radio" id="cor" name="busca" value="3" <?php if($busca == "3"){echo "checked";}?>>
                ...
                <div class="">
                    <table id="example" class="table table-striped" style="background-color: #FFF;">
                        ...
                        <?php
                            ...
                            $tabela = Quadrado::listar($busca, $pesquisa);
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row"><a href="quadrado.php?id=<?php echo $value['id'];?>"><img src="../../img/edit.svg" style="width: 3vw;"></a></td>
                                <td><a onclick="return confirm('Deseja mesmo excluir?')" href="../controle/controleGeral.php?id=<?php echo $value['id'];?>&operation=delete&table=quadrado"><img src="../../img/delete.svg" style="width: 3vw;"></a></td>
                                <td><a href="../show/showQuadrado.php?id=<?php echo $value['id']; ?>&lado=<?php echo $value['lado'];?>&cor=<?php echo str_replace('#', '%23', $value['cor']);?>&tabuleiro_id=<?php echo $value['tabuleiro_id']?>"><img src='../../img/list.svg' style="width: 3vw;"></a></td>
                            </tr>
                        <?php
                            } 
                        ?> 
            ...
            <div class="tab-pane fade  <?php if(isset($id)){echo 'show active';} ?>" id="nav-form" role="tabpanel" aria-labelledby="nav-form-tab" tabindex="0">
                <form action="<?php if(isset($_GET['id'])) { echo "../controle/controleGeral.php?id=$id&operation=update&table=quadrado";} else {echo "../controle/controleGeral.php?operation=create&table=quadrado";} ?>" method="post" id="form" style="padding-left: 5vw; padding-right: 5vw;">
                    <br>
                    <h1>Cadastro Quadrado</h1>
                    <br>
